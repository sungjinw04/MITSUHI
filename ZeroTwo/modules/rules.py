...
from ZeroTwo.modules.helper_funcs.string_handling import markdown_parser, markdown_to_html
...
def send_rules(update, chat_id, from_pm=False):
    ...
    if from_pm:
        bot.send_message(user.id, text, parse_mode=ParseMode.HTML, disable_web_page_preview=True)
    else:
