...
from ZeroTwo.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text(
                    "❤️ <b>Thanks for adding me to the group!</b>\n\n<b>Appoint me as administrator in the Group, Otherwise I will not be able to work properly.</b>", parse_mode=ParseMode.HTML,
                    reply_to_message_id=reply,
                )
                creator = None
                ...
                if creator:
                    ...
                    group_members_count = bot.get_chat_members_count(chat.id)
                    bot.send_message(
                        meow,
                        f"""
                        #NEWGROUP
                        \n<b>Group Name:</b> {chat.title}
                        \n<b>ID:</b> <code>{chat.id}</code>
                        \n<b>Creator ID:</b> <code>{creator.id}</code>
                        \n<b>Adder:</b> {admin_mention}
                        \n<b>Members Count:</b> <b>{group_members_count}</b>
                        """,
