...
from ZeroTwo import OWNER_ID as OWNER, BOT_USERNAME, pgram as app
from ..anibot.data_parser import (
    get_all_genres,
    get_all_tags,
    get_studio_animes,
    get_studios,
...
from ..anibot.db import get_collection
...
@app.on_message(
    filters.command(["anime", f"anime{BOT_USERNAME}"])
)
@control_user
...
@app.on_message(
    filters.command(["character", f"character{BOT_USERNAME}"])
)
@control_user
...
@app.on_message(
    filters.command(["anilist", f"anilist{BOT_USERNAME}"])
)
@control_user
...
@app.on_message(filters.command(["top", f"top{BOT_USERNAME}"]))
@control_user
...
@app.on_message(filters.command(["studio", f"studio{BOT_USERNAME}"]))
@control_user
...
@app.on_message(
    filters.command(["airing", f"airing{BOT_USERNAME}"])
)
@control_user
...
@app.on_message(
    filters.command(["browse", f"browse{BOT_USERNAME}"])
)
@control_user
...
@app.on_edited_message(
    filters.command(["manga", f"manga{BOT_USERNAME}"])
)
...
@app.on_edited_message(
    filters.command(["top", f"top{BOT_USERNAME}"])
)
...
@app.on_message(
    filters.command(["studio", f"studio{BOT_USERNAME}"])
)
